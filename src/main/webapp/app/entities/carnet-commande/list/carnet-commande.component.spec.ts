...
describe('CarnetCommande Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'carnet-commande', component: CarnetCommandeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.carnetCommandes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to carnetCommandeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCarnetCommandeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCarnetCommandeIdentifier).toHaveBeenCalledWith(entity);
