package com.zeddini.monolithe.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.zeddini.monolithe.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.zeddini.monolithe.repository.UserRepository.USERS_BY_EMAIL_CACHE);
