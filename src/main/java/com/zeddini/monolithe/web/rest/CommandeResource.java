...
import com.zeddini.monolithe.service.CommandeService;
...
/**
 * REST controller for managing {@link com.zeddini.monolithe.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
public class CommandeResource {
    ...
    public ResponseEntity<List<Commande>> getAllCommandes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
